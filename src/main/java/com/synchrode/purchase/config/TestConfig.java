package com.synchrode.purchase.config;
...
import com.synchrode.purchase.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategories().add(cat2); // associação entre os objetos Product e Category
		...
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5)); // salva novamente
